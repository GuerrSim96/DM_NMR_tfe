...
> The MDS-pVT system requires approximately 1.02 GB for installation on the drive, and each simulation saves on the drive from 0.70 GB to 1.82 GB of data size.
